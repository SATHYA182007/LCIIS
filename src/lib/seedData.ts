...
// Seed Lab History for Hospital Patients (Only active portal patients: LCIIS-P-000001 & LCIIS-P-000002)
export const INITIAL_LAB_RESULTS: LaboratoryResult[] = [
  ...
  },
  {
    ...
    referenceLow: 0.0,
    referenceHigh: 0.15,
    sampleCollectedAt: new Date(Date.now() - 5 * 3600000).toISOString(),
    resultedAt: new Date(Date.now() - 4.5 * 3600000).toISOString(),
    technicianId: 'user-lab-1',
    technicianName: 'Robert Vance, MLS',
    source: 'LIS_AUTOMATED',
    verificationStatus: 'VERIFIED',
    notes: 'Markedly elevated systemic bacterial sepsis marker.',
  ...
  },
  {
    ...
    referenceLow: 70,
    referenceHigh: 140,
    sampleCollectedAt: new Date(Date.now() - 4 * 3600000).toISOString(),
    resultedAt: new Date(Date.now() - 3.5 * 3600000).toISOString(),
    technicianId: 'user-lab-1',
    technicianName: 'Robert Vance, MLS',
    source: 'LIS_AUTOMATED',
    verificationStatus: 'VERIFIED',
    notes: 'Stress-induced hyperglycemia secondary to sepsis.',
