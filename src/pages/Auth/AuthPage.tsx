      ...
      <div className="hidden lg:flex lg:w-5/12 bg-gradient-to-br from-slate-950 via-teal-950/90 to-slate-900 p-12 text-white flex-col justify-between relative z-10 border-r border-slate-800/80 backdrop-blur-xl">
        ...
        <div className="space-y-8 my-auto">
          <div className="space-y-3">
            <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-white/10 border border-white/15 text-xs text-teal-200 font-semibold backdrop-blur-md">
              ...
              <span>Real-Time Hospital Patient Registration & Telemetry</span>
            </div>

            <h1 className="text-3xl xl:text-4xl font-black text-white tracking-tight leading-tight">
              Unified Medical Portal & Clinical Operations.
            </h1>
            <p className="text-slate-300/90 text-sm leading-relaxed">
              Seamless patient registration, longitudinal telemetry streams, and role-restricted healthcare access across all hospital departments.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between text-xs text-slate-400/80 border-t border-slate-800/60 pt-4">
          <span className="flex items-center">
            <ShieldCheck className="w-4 h-4 mr-1.5 text-teal-400" /> Firebase Auth & Role Security
          </span>
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 mt-1">
                {mode === 'forgot-password'
                  ...
                  : 'Enter your authenticated credentials to access your designated hospital workstation.'}
              </p>
            </div>
          </div>
          ...
          <AnimatePresence>
            ...
            {resetSuccess && (
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                exit={{ opacity: 0, y: -10 }}
                className="p-3.5 bg-emerald-50 border border-emerald-200 text-emerald-800 text-xs rounded-xl font-semibold flex items-start space-x-2"
              >
                <CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0 mt-0.5" />
                <span>Instructions have been dispatched to your email address if registered in Firebase.</span>
              </motion.div>
            )}
          </AnimatePresence>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 text-xs bg-white border border-slate-200 rounded-xl font-medium focus:ring-2 focus:ring-teal-500 focus:border-teal-500 focus:outline-hidden transition-all shadow-xs font-mono uppercase"
                    required
                  />
                </div>
              </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div>
                          ...
                          <div className="text-[10px] text-slate-400 font-medium truncate mt-0.5">{item.label}</div>
                          <div className="text-[9px] font-mono text-slate-500 bg-slate-100 px-1.5 py-0.5 rounded truncate mt-1 border border-slate-200/60">
                            {demoEmailMap[item.id]}
                          </div>
                        </div>
                      </button>
                    );
