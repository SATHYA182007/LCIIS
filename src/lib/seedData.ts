...
// Seed Lab History for Hospital Patients
export const INITIAL_LAB_RESULTS: LaboratoryResult[] = [
  // Patient 1: LCIIS-P-000001 (Test Patient / Eleanor Vance - ICU Acute Kidney Injury & Inflammatory Escalation)
  {
    id: 'lab-p001-1',
    ...
    referenceLow: 0.6,
    referenceHigh: 1.2,
    sampleCollectedAt: new Date(Date.now() - 24 * 3600000).toISOString(),
    resultedAt: new Date(Date.now() - 23.5 * 3600000).toISOString(),
    technicianId: 'user-lab-1',
    technicianName: 'Robert Vance, MLS',
    source: 'LIS_AUTOMATED',
    verificationStatus: 'VERIFIED',
    notes: 'Baseline renal function reading.',
  ...
  },
  {
    ...
    referenceLow: 0.6,
    referenceHigh: 1.2,
    sampleCollectedAt: new Date(Date.now() - 2 * 3600000).toISOString(),
    resultedAt: new Date(Date.now() - 1.5 * 3600000).toISOString(),
    technicianId: 'user-lab-1',
    technicianName: 'Robert Vance, MLS',
    source: 'LIS_AUTOMATED',
    verificationStatus: 'VERIFIED',
    notes: 'Upward creatinine trajectory detected.',
  ...
  },
  {
    ...
    source: 'LIS_AUTOMATED',
    verificationStatus: 'VERIFIED',
    notes: 'Persistent elevated inflammatory marker.',
    createdAt: new Date(Date.now() - 1.5 * 3600000).toISOString(),
  },

  // Patient 2: LCIIS-P-000002 (Marcus Vance - ICU Critical Sepsis & Leukocytosis)
  {
    id: 'lab-p002-1',
    patientId: 'LCIIS-P-000002',
    testName: 'WBC (White Blood Count)',
    category: 'Hematology',
    value: 18.4,
    unit: 'x10^3/uL',
    referenceLow: 4.5,
    referenceHigh: 11.0,
    sampleCollectedAt: new Date(Date.now() - 6 * 3600000).toISOString(),
    resultedAt: new Date(Date.now() - 5.5 * 3600000).toISOString(),
    technicianId: 'user-lab-1',
    technicianName: 'Robert Vance, MLS',
    source: 'LIS_AUTOMATED',
    verificationStatus: 'VERIFIED',
    notes: 'Leukocytosis associated with acute septic response.',
  ...
  },
  {
    ...
    source: 'LIS_AUTOMATED',
    verificationStatus: 'VERIFIED',
    notes: 'Hypoperfusion lactate elevation.',
    createdAt: new Date(Date.now() - 5.5 * 3600000).toISOString(),
  },

  // Patient 3: LCIIS-P-000003 (Elena Rostova - Cardiology Cardiac Markers)
  {
    id: 'lab-p003-1',
    patientId: 'LCIIS-P-000003',
    testName: 'Troponin I',
    category: 'Biochemistry',
    value: 1.8,
    unit: 'ng/mL',
    referenceLow: 0.0,
    referenceHigh: 0.04,
    sampleCollectedAt: new Date(Date.now() - 8 * 3600000).toISOString(),
    resultedAt: new Date(Date.now() - 7.5 * 3600000).toISOString(),
    technicianId: 'user-lab-1',
    technicianName: 'Robert Vance, MLS',
    source: 'LIS_AUTOMATED',
    verificationStatus: 'VERIFIED',
    notes: 'Post-op cardiac marker tracking.',
  ...
  // Patient 4: LCIIS-P-000004 (David Chen - Telemetry Electrolytes & Blood Glucose)
  {
    id: 'lab-p004-1',
    ...
    referenceLow: 3.5,
    referenceHigh: 5.1,
    sampleCollectedAt: new Date(Date.now() - 10 * 3600000).toISOString(),
    resultedAt: new Date(Date.now() - 9.5 * 3600000).toISOString(),
    technicianId: 'user-lab-1',
    technicianName: 'Robert Vance, MLS',
    source: 'LIS_AUTOMATED',
    verificationStatus: 'VERIFIED',
  ...
  // Patient 5: LCIIS-P-000005 (Sophia Patel - Recovery Complete Blood Count)
  {
    id: 'lab-p005-1',
    patientId: 'LCIIS-P-000005',
    testName: 'Hemoglobin',
    category: 'Hematology',
    value: 12.8,
    unit: 'g/dL',
    referenceLow: 12.0,
    referenceHigh: 16.0,
    sampleCollectedAt: new Date(Date.now() - 14 * 3600000).toISOString(),
    resultedAt: new Date(Date.now() - 13.5 * 3600000).toISOString(),
    technicianId: 'user-lab-1',
    technicianName: 'Robert Vance, MLS',
    source: 'LIS_AUTOMATED',
    verificationStatus: 'VERIFIED',
    notes: 'Normal post-op hematocrit profile.',
    createdAt: new Date(Date.now() - 13.5 * 3600000).toISOString(),
  },
  {
    id: 'lab-p005-2',
    patientId: 'LCIIS-P-000005',
